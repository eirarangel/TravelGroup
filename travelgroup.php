...
<html lang="en">
    <head>
        <!-- Basic -->
        <meta charset="utf-8">
        <title>TravelGroup - College Holidays</title>
                        ...
                        <div class="row icon-row">
                            <a href="#">
                                <div class="col-md-3 banner-col"> 
                                    <h2>DUMMY 1</h2> 
                                    <h3 class="fa fa-ship icon-banner"></h3>
                                </div>
                            </a>
                            <a href="#">                            
                                <div class="col-md-3  banner-col">
                                    <h2>DUMMY 2</h2>
                                    <h3 class="fa fa-graduation-cap icon-banner"></h3>
                                </div>
                            </a>
                            <a href="#">                                
                                <div class="col-md-3  banner-col">
                            ...
                            <a href="#">                                
                                <div class="col-md-3">
                                    <h2>DUMMY 4</h2> 
                                    <h3 class="fa fa-bed icon-banner"></h3>
                                </div>
                            </a>                                
                        </div>
           ...
           <!-- End content info - Features-->
                ...
                <!-- Item Gallery Grid View--> 
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="img-hover">
                                            <img src="img/hotel-img/3.jpg" alt="" class="img-responsive">
                                            <div class="overlay"><a href="img/hotel-img/3.jpg" class="fancybox"><i class="fa fa-plus-circle"></i></a></div>
                                        </div>
